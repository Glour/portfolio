    ...
    <footer className="border-t border-white/8 bg-black">
      <div className="container mx-auto max-w-5xl px-6 py-14">
        <div className="flex flex-col gap-10 md:flex-row md:items-start md:justify-between">
          ...
          {/* Brand */}
          <div>
            <p className="font-mono text-[11px] tracking-[0.3em] text-primary-400/50 uppercase">
              {profile.name}
            </p>
            <p className="mt-3 max-w-sm text-sm leading-[1.75] text-white/55">
              {profile.bio[0]}
            </p>
            <div className="mt-5 flex gap-5">
              {profile.social.github && (
                <a href={profile.social.github} target="_blank" rel="noopener noreferrer"
                   className="text-sm font-medium text-white/45 transition-colors duration-200 hover:text-primary-400">
                  GitHub
                </a>
              )}
          ...
          {/* Contact */}
          <div>
            <p className="font-mono text-[11px] tracking-[0.3em] text-primary-400/50 uppercase">{t('title')}</p>
